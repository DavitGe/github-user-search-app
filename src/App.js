          ...
          <div className="flex flex-col w-full">
            ...
            <div className="mt-[37px] flex w-full flex-wrap">
              <div className="flex flex-row items-center basis-1/2 overflow-hidden">
                ...
                <span className="whitespace-nowrap text-[15px] text-text dark:text-dText">
                  San Francisco
                </span>
              </div>
              <div className="flex flex-row items-center basis-1/2 overflow-hidden">
                ...
                <span className="whitespace-nowrap text-[15px] text-text opacity-50 dark:text-dText">
                  Not Available
                </span>
              </div>
              <div className="flex flex-row items-center basis-1/2 mt-5 overflow-hidden">
                ...
                <span className="whitespace-nowrap text-[15px] text-text -ml-1 dark:text-dText">
                  https://github.blog
                </span>
              </div>
              <div className="flex flex-row items-center basis-1/2 mt-5 overflow-hidden">
